...
class Music(commands.Cog):
    ...
    @commands.command(name='connect', aliases=['join'],help = "Connects to a voice channel")
    ...
    @commands.command(name='play', aliases=['stream','p'],help = "Plays a song or adds it to the queue")
    ...
    @commands.command(name='skip',aliases = ['next'],help = "Skips the song")
    ...
    @commands.command(name='queue', aliases=['q', 'playlist'],help = "Displays the queue")
    ...
    @commands.command(name='now_playing', aliases=['np', 'current', 'currentsong', 'playing'],help = "Shows the current playing song")
    ...
    @commands.command(name='volume', aliases=['vol','v'],help = "Changes the volume")
    ...
    @commands.command(name='stop',help ="Stops playing the song and makes bot leave channel")
